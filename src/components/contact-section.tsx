                ...
                <div className="space-y-10 text-white">
                    <div>
                        <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">
                            Start Your <span className="text-sky-400 italic">Journey</span>
                        </h2>
                    ...
                    <div className="space-y-8">
                        <ContactItem
                            ...
                            content={
                                <div className="flex flex-col gap-1">
                                    <a href="tel:+918817777504" className="hover:text-sky-300 transition-colors">+91 881-777-7504</a>
                                    <a href="tel:+916263435093" className="hover:text-sky-300 transition-colors">+91 626-343-5093</a>
                                </div>
                            }
                        />
                        ...
                        <ContactItem
                            ...
                            title="Email Us"
                            content={
                                <a href="mailto:preetesh.tour.travel969@gmail.com" className="hover:text-sky-300 transition-colors">
