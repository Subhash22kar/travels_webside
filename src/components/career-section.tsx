...
export function CareerSection() {
    return (
        <SectionWrapper
            ...
            overlayOpacity="bg-white/95 dark:bg-neutral-900/95"
        >
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {/* Culture Card */}
                <div className="bg-white dark:bg-neutral-800 p-8 rounded-2xl border border-neutral-100 dark:border-neutral-700 shadow-xl hover:shadow-2xl transition-all duration-300 group">
                    ...
                    <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                        <li className="flex items-center gap-2"><span className="text-brand-saffron">✨</span> Global travel opportunities</li>
                        <li className="flex items-center gap-2"><span className="text-brand-saffron">✨</span> Competitive compensation</li>
                        <li className="flex items-center gap-2"><span className="text-brand-saffron">✨</span> Dynamic & creative environment</li>
                        <li className="flex items-center gap-2"><span className="text-brand-saffron">✨</span> Shape the future of tourism</li>
                    </ul>
                </div>

                {/* Apply Card */}
                <div className="bg-gradient-to-br from-brand-blue to-blue-900 p-8 rounded-2xl shadow-xl text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <a
                        ...
                        className="relative z-10 inline-flex items-center justify-center gap-3 bg-white text-brand-blue px-8 py-4 rounded-xl font-bold hover:bg-neutral-100 transition-colors shadow-lg"
                    >
