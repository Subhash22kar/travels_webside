            ...
            <div className="relative z-10 container mx-auto px-4 text-center text-white">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-medium drop-shadow-md">
                        ...
                        Ajanta • Ellora • Bodh Gaya • Sarnath • Lumbini
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="mt-12 bg-white/95 backdrop-blur-md p-4 md:p-6 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.2)] max-w-5xl mx-auto text-black border border-white/50"
                >
                    <form className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        <div className="space-y-1 text-left">
                            ...
                            <select className="w-full p-3 bg-neutral-50 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-brand-saffron outline-none hover:bg-neutral-100 transition-colors cursor-pointer">
                        ...
                        <div className="space-y-1 text-left">
                            ...
                            <input
                                type="date"
                                className="w-full p-3 bg-neutral-50 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-brand-saffron outline-none cursor-pointer"
                            />
                        </div>
                        ...
                        <div className="space-y-1 text-left">
                            ...
                            <select className="w-full p-3 bg-neutral-50 border border-neutral-200 rounded-lg focus:ring-2 focus:ring-brand-saffron outline-none cursor-pointer">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full p-3 bg-gradient-to-r from-brand-saffron to-brand-gold text-white font-bold rounded-lg shadow-lg flex items-center justify-center gap-2 hover:shadow-orange-500/40 transition-shadow"
                        >
                            <Search size={18} />
                            Find Packages
                        </motion.button>
